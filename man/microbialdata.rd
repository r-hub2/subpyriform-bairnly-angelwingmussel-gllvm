...
\docType{data}
\alias{microbialdata}
\title{Microbial community data}
\usage{
  data(microbialdata)
}
\format{
  \describe{
    \item{Y}{A data frame with abundances of 985 bacteria species measured at 56 soil sample sites}
    \item{X}{Environmental variables SOM: soil organic matter, pH: soil pH value and Phosp: available phosphorus and information from the samples, including Region: sampling region (Kilpisjarvi (Finland), Ny-Alesund (Norway), and Mayrhofen (Austria).), Site: sampling site and Soiltype: soil sample type (top soil (T) or bottom soil (B))}
  }}
\description{
